...
def DataHider(C,lenB):
	...
	return C,t
def Receiver(C,t,lenB,rows,cols):
	...
	cv2.imshow("result0432", new_image)
	cv2.imwrite("result0432.png", new_image)
...
def main():
	...
	lenB=3
	C2,t=DataHider(C,lenB)
	# print('携带隐藏数据的加密载体数据：')
	# print(encryptData2)
	Receiver(C2,t,lenB,rows,cols)
