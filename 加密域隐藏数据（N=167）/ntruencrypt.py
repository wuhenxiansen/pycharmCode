...
def Owner():
	...
	print('\t数据拥有者加密过程:\n')
	image = cv2.imread(r"08.png", cv2.IMREAD_GRAYSCALE)  # 以灰度模式加载图片
	# print(image)
...
def main():
	...
	C2,rows1,cols1,rows2,cols2,used_time=DataHider(C,40,40)

	Receiver(C2,40,40,rows,cols,rows1,cols1,rows2,cols2)
